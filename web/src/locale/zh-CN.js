export default {
	...
	"GENERATOR.TITLE": "生成客户端",
	"GENERATOR.NOTE": "生成的客户端将使用以下连接信息回连。",
	"GENERATOR.CONNECTION": "连接信息",
	"GENERATOR.PREVIEW": "连接预览",
	"GENERATOR.HOST_HELP": "客户端要连接的主机名或 IP。",
	"GENERATOR.PORT_HELP": "当前服务器监听的端口。",
	"GENERATOR.PATH_HELP": "客户端访问 /ws 与 /api 的基础路径。",
	"GENERATOR.OS_ARCH_HELP": "选择目标操作系统与架构。",
	"GENERATOR.HOST_REQUIRED": "主机必填",
	"GENERATOR.PORT_REQUIRED": "端口必填",
	"GENERATOR.PATH_REQUIRED": "路径必填",
	"GENERATOR.OS_ARCH_REQUIRED": "操作系统/架构必填",
