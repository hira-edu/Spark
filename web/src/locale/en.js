export default {
	...
	"DESKTOP.POLICY_DISPLAY_PROTECTION": "Remote screen is hidden by local policy",
	"DESKTOP.POLICY_DISPLAY_PROTECTION_DESC": "The remote endpoint set SetWindowDisplayAffinity or a similar privacy control. Request Force Capture or have the user allow screen sharing.",
	"DESKTOP.POLICY_INPUT_BLOCKED": "Remote input blocked by local policy",
	"DESKTOP.POLICY_INPUT_BLOCKED_DESC": "A local control (BlockInput, filter driver, kiosk mode) is rejecting keyboard and mouse events. Use Force Input if authorized or continue in view-only mode.",
	"DESKTOP.WEBRTC_BETA": "WebRTC (beta)",
	"DESKTOP.WEBRTC_DISABLED": "WebRTC disabled for this session.",
	"DESKTOP.WEBRTC_DATA_ERROR": "WebRTC data channel error.",
	"DESKTOP.WEBRTC_FAILED": "WebRTC connection failed.",
	"DESKTOP.WEBRTC_SIGNAL_FAILED": "WebRTC signalling failed.",
	"DESKTOP.WEBRTC_UNSUPPORTED": "Remote device does not support WebRTC yet.",
	"DESKTOP.WEBRTC_BROWSER_UNSUPPORTED": "Browser does not support WebRTC.",
	"DESKTOP.WEBRTC_FALLBACK": "WebRTC unavailable.",
	"DESKTOP.WEBRTC_FALLBACK_NOTICE": "Switching back to the default diff transport.",
	"DESKTOP.WEBRTC_FALLBACK_SHORT": "WebRTC fallback",
